...
// ######################################################################
void Vector2D::writeToStream(ostream& os) const
{
  if (valid) os << "1\n";
  else os << "0\n";
  os << itsX << ' ' << itsY << '\n';
...
// ######################################################################
void Vector2D::readFromStream(istream& is)
{
  int i; is >> i;
  valid = (i == 1);
  is >> itsX;
...
// ######################################################################
StraightLine2D::StraightLine2D(istream& is)
{
  readFromStream(is);
}
...
// ######################################################################
void StraightLine2D::writeToStream(ostream& os) const
{
  if (valid) os << "1\n";
  else os << "0\n";
...
// ######################################################################
void StraightLine2D::readFromStream(istream& is)
{
  int i; is >> i;
  valid = (i == 1);
...
// ######################################################################
LineSegment2D::LineSegment2D(istream& is)
{
  readFromStream(is);
}
...
// ######################################################################
void LineSegment2D::writeToStream(ostream& os) const
{
  if (valid) os << "1\n";
  else os << "0\n";
...
// ######################################################################
void LineSegment2D::readFromStream(istream& is)
{
  int i; is >> i;
  valid = (i == 1);
